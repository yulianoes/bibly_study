...
<head>
    ...
    <title>Sessão Expirada - Bible Study</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 5rem; font-weight: 600; background: linear-gradient(135deg, var(--primary), #6366f1); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 1rem; }
...
<body>
    <div class="error-card">
        ...
        <p class="error-desc">Parece que a sua sessão expirou por inatividade. Por favor, recarregue a página para continuar o seu estudo.</p>
        <a href="/" class="btn-home"><i class="bi bi-arrow-clockwise"></i> Recarregar Página</a>
    </div>
    <script>
