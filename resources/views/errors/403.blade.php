...
<head>
    ...
    <title>Acesso Negado - Bible Study</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 5rem; font-weight: 600; background: linear-gradient(135deg, #f59e0b, #ef4444); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; margin-bottom: 1rem; }
...
<body>
    <div class="error-card">
        ...
        <h1 class="error-title">Acesso Restrito</h1>
        <p class="error-desc">Não tem permissão para aceder a esta área do saber. Verifique as suas credenciais ou volte ao início.</p>
        <a href="/" class="btn-home"><i class="bi bi-shield-lock"></i> Voltar ao Início</a>
    </div>
    <script>
